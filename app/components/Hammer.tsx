    ...
    >
      ...
      <div className="flex h-[65%] items-center justify-center gap-2">
        ...
        <motion.div
          ...
          className="w-0.5 h-6 mb-3 mr-1 bg-[#54e8b4]"
        ></motion.div>

        {/* Left Green Line (short) */}
        <motion.div
          variants={itemVariants}
          className="w-0.5 h-6 mr-1 bg-[#54e8b4]"
        ></motion.div>
        ...
        >
          {/* Body (square) */}
          <div className="w-2.5 h-4 bg-[#54e8b4] mt-12"></div>
          {/* Long shadow/wick below */}
          <div className="w-0.5 h-8 bg-[#54e8b4]"></div>
          {/* Small yellow star near left lines */}
          <div className="text-yellow-400 text-[8px] absolute top-10 right-3">
            ✦
          </div>
          {/* Small yellow star near left lines */}
          <div className="text-yellow-400 text-[8px] absolute top-16 left-3">
            ✦
          </div>
        </motion.div>
        ...
        <motion.div
          variants={itemVariants}
          className="w-0.5 h-9 ml-1 mb-1 bg-[#d9304f]"
        ></motion.div>

        {/* Right Red Line (tall) */}
        <motion.div
          variants={itemVariants}
          className="w-0.5 h-9 mb-4 ml-1 bg-[#d9304f]"
        ></motion.div>
      </div>
